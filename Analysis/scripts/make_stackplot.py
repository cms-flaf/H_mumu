...
if __name__ == '__main__':
    ...
    jet_vars = ["delta_eta_jj", "j1_eta", "j2_eta", "m_jj", "VBFjets_eta", "VBFjets_pt", "j1_pt", "j2_pt"]
    if args.categories:
    ...
    for var in varnames:
        for cat in categories:
            ...
            if var in jet_vars and cat in ["baseline", "ggH"]: continue
