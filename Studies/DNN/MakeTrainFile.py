...
if __name__ == '__main__':
    ...
    parser.add_argument('--globalConfig', required= True, type=str, help="global config for regions and categories def")
    ...
    for i, yamlname in enumerate(yaml_list):
        ...
        create_file(config_dict,  global_cfg_dict, args.period,output_folder, "/afs/cern.ch/work/v/vdamante/H_mumu/Studies/DNN/test.root")#config_dict['meta_data']['input_filename']))