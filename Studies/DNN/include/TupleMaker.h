...
namespace analysis {
typedef std::variant<int,float,bool, unsigned long,unsigned long long,long,unsigned int, unsigned char, RVecI, RVecF, RVecUC, RVecShort,RVecUL,RVecULL,RVecB> MultiType;
