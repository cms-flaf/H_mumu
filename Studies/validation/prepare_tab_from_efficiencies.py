...
base = "/afs/cern.ch/work/v/vdamante/H_mumu/Studies/validation"
infile = f"{base}/new_Efficiencies/{period}/eff_{sample}.root"
outdir = f"{base}/new_tables/{period}"
os.makedirs(outdir, exist_ok=True)

f = ROOT.TFile.Open(infile)
t = f.Get("Efficiencies")
...
outfile = f"{outdir}/eff_{sample}.tsv"
df.to_csv(outfile, sep="\t", index=False)

print(f"Table saved in {outfile}")
