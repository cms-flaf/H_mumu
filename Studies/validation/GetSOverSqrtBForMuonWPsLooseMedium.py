...
for WP in [0.2]:
    for Id_WP in ["loose", "medium"]:
        ...
        print(f"bckg_baseline_before_isoCut = {bckg_baseline_before_isoCut}")
        ...
        print(f"bckg_baseline_before_isoCut_inSigMassRegion = {bckg_baseline_before_isoCut_inSigMassRegion}")
        ...
        print(f"bckg_baseline = {bckg_baseline}")
        ...
        print(f"bckg_baseline_inSigMassRegion = {bckg_baseline_inSigMassRegion}")
        ...
        print(f"sig_baseline_before_isoCut = {sig_baseline_before_isoCut}")
        ...
        print(f"sig_baseline_before_isoCut_inSigMassRegion = {sig_baseline_before_isoCut_inSigMassRegion}")
        ...
        print(f"sig_baseline = {sig_baseline}")
        ...
        print(f"sig_baseline_inSigMassRegion = {sig_baseline_inSigMassRegion}")
        ...
        print(f"signal efficiency: baseline = {sig_baseline_inSigMassRegion/sig_baseline_before_isoCut_inSigMassRegion}, ggH = {sig_ggH/sig_baseline_before_isoCut_inSigMassRegion}, VBF = {sig_VBF/sig_baseline_before_isoCut_inSigMassRegion}")
        print(f"signal efficiency w.r.t. to entire phase space: baseline(all mass range) = {sig_baseline/sig_baseline_before_isoCut}, baseline = {sig_baseline_inSigMassRegion/sig_baseline_before_isoCut}, ggH = {sig_ggH/sig_baseline_before_isoCut}, VBF = {sig_VBF/sig_baseline_before_isoCut}")
        print()
