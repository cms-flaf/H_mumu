observables = {
    ...
    "Muon": {
        ...
        "MC": ["Muon_genPartFlav", "Muon_genPartIdx"],
    },
    "OtherPV": {"base": ["OtherPV_score", "OtherPV_z"]},
    "PFCand": {
        "base": [],
        "v15": [
            "PFCand_eta",
    ...
    "Photon": {
        ...
        "v15": ["Photon_hoe_Tower", "Photon_superclusterEta"],
    },
    "PV": {
        "base": [
            "PV_chi2",
...
def GetObservablesCols(obs_name, isData, nano_version="v12"):
    ...
    if not isData and "MC" in obs_dict.keys():
